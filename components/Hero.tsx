...
const Hero: React.FC<Props> = ({ pinnedItems }) => {
	return (
		<div className="relative">
			<div className="absolute bottom-0 left-0 h-full w-full [&>svg]:absolute [&>svg]:inset-0 [&>svg]:h-full [&>svg]:w-full">
				<HeroWave />
			</div>
