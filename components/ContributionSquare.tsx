...
const ContributionSquare: React.FC<ContributionSquareProps> = ({ count, color, contributionLevel, date }) => {
	...
	return (
		...
		>
			<div className="absolute top-0 right-1/2 z-10 hidden w-max -translate-y-full translate-x-1/2 rounded-md bg-black/90 py-1 px-4 text-xs text-white hover:block group-hover:block md:text-sm">
				{count == 0
