		...
		<section className="min-h-screen w-screen bg-white p-5 md:p-10">
			...
			<div className="my-10 grid grid-cols-2 gap-3 py-4 lg:grid-cols-3">
				<div className="flex flex-col gap-3">
					<div className="rounded-md bg-amber-500 text-amber-500">
						<StackCard title="Javascript" date="2021-2022">
					...
					<div className="rounded-md bg-blue-600 text-blue-600">
					...
					<div className="rounded-md bg-rose-600 text-rose-600">
					...
					<div className="rounded-md bg-fuchsia text-fuchsia">
						<StackCard title="Sass/Scss" date="2019-2022">
							Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex, nostrum voluptates nesciunt qui
							saepe facere ipsam similique voluptate, exercitationem doloremque tenetur consequatur?
						</StackCard>
					</div>
				...
				<div className="flex flex-col gap-3">
					...
					<div className="rounded-md bg-sky-400 text-sky-400">
					...
					<div className="rounded-md bg-lime-600 text-lime-600">
						<StackCard title="Mongo DB" date="2019-2022">
							Lorem ipsum, dolor sit amet consectetur adipisicing elit. Praesentium, dolorem.
						</StackCard>
					</div>
					<div className="rounded-md bg-orange-500 text-orange-500">
						<StackCard title="Firebase" date="2019-2022">
					...
					<div className="rounded-md bg-cyan-400 text-cyan-400">
						<StackCard title="Tailwind" date="2019-2022">
				...
				<div className="flex flex-col gap-3">
					<div className="rounded-md bg-sky-500 text-sky-500">
						<StackCard title="React" date="2019-2022">
					...
					<div className="rounded-md bg-[#000] text-white">
						<StackCard title="Next.js" date="2019-2022">
							Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas placeat autem alias fugit
							accusamus!
						</StackCard>
					</div>
					<div className="rounded-md bg-rose-700 text-rose-700">
						<StackCard title="NPM" date="2019-2022">
							Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex, nostrum voluptates nesciunt qui
							saepe facere ipsam similique voluptate, exercitationem doloremque tenetur consequatur?
						</StackCard>
					</div>
					<div className="rounded-md bg-lime-500 text-lime-500">
						<StackCard title="Node" date="2019-2022">
			...
			<div className="h-10 w-max bg-red">
